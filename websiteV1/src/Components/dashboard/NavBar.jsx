...
const NavBar = ({ onSearch }) => {
 ...
 const shouldDisplaySearchBar = (location.pathname === "/create-campaign" ||
  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-around mr-5 mb-[35px] gap-6 mt-3">
      <Auth ref={inputRef} />
      ...
      <div className="w-[52px] h-[52px] rounded-full bg-[#2c2f32] flex  ml-auto justify-center items-center cursor-pointer relative">
        <img
          style={{
            opacity: connect ? 0 : 1,
          }}
