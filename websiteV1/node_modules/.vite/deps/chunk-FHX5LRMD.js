...
} from "./chunk-YPIP2NWL.js";
import {
  getInjectedPhantomProvider
} from "./chunk-KPKZPEP6.js";
import {
  getInjectedRainbowProvider
} from "./chunk-QGF3KIAK.js";
import {
  ENTRYPOINT_ADDRESS,
  ERC6551_REGISTRY,
  getAnalyticsHeaders,
  require_dist
} from "./chunk-RVXESCB5.js";
import {
  ThirdwebSDK
} from "./chunk-KGESJUY5.js";
import {
  WagmiAdapter
} from "./chunk-GCCNDEE6.js";
import {
  getInjectedOKXProvider
} from "./chunk-OQFX5SOH.js";
import {
  getInjectedCoreWalletProvider
} from "./chunk-ASFUISJ3.js";
import {
  getInjectedOneKeyProvider
} from "./chunk-5RZYZZWN.js";
import {
  getInjectedCryptoDefiWalletProvider
} from "./chunk-OO4OYK3Z.js";
import {
  getInjectedRabbyProvider
} from "./chunk-SBKPM5TM.js";
import {
  getInjectedCoin98Provider
} from "./chunk-VQW2VKWU.js";
import {
...
import {
  normalizePriceValue
} from "./chunk-HRJETLMW.js";
import {
  fetchCurrencyValue,
  isNativeToken
} from "./chunk-K4TVDPYY.js";
import {
...
var BloctoWallet = class _BloctoWallet extends AbstractClientWallet {
  ...
  async initConnector() {
    ...
    const {
      BloctoConnector
    } = await import("./thirdweb-dev-wallets-evm-connectors-blocto.browser.esm-26VFA3BP.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          MetaMaskConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-metamask.browser.esm-O24RLTQP.js");
        ...
        } = await import("./thirdweb-dev-wallets-evm-connectors-wallet-connect.browser.esm-YEI4GA4O.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          OKXConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-okx.browser.esm-AXWZ6QEA.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          CoreWalletConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-core-wallet.browser.esm-YY3VEW5J.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          OneKeyConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-onekey.browser.esm-6KGQI5PM.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        ...
        } = await import("./thirdweb-dev-wallets-evm-connectors-crypto-defi-wallet.browser.esm-PVRV5PE4.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          RabbyConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-rabby.browser.esm-WQ2OH6PC.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          Coin98Connector
        } = await import("./thirdweb-dev-wallets-evm-connectors-coin98.browser.esm-QLWXRYF3.js");
...
var PaperWallet = class _PaperWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-paper.browser.esm-3CE5T267.js");
...
var CoinbaseWallet = class _CoinbaseWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-coinbase-wallet.browser.esm-O5XIG3Q7.js");
...
var EmbeddedWallet = class _EmbeddedWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-embedded-wallet.browser.esm-B2NNK2A6.js");
...
var FrameWallet = class _FrameWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        FrameConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-frame.browser.esm-BL47FEE5.js");
...
var InjectedWallet = class _InjectedWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        InjectedConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-injected.browser.esm-3OAKLDNV.js");
...
var LocalWallet = class _LocalWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-local-wallet.browser.esm-F34ZDNWA.js");
...
var SignerWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        SignerConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-signer.browser.esm-T7H7P23Q.js");
      if (!this.signer) {
...
var MagicLink = class _MagicLink extends AbstractClientWallet {
  ...
  async initializeConnector() {
    const {
      MagicAuthConnector
    } = await import("./thirdweb-dev-wallets-evm-connectors-magic.browser.esm-RNRGH2FZ.js");
...
var XDEFIWallet = class _XDEFIWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        XDEFIConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-xdefi.browser.esm-V3GNS5ZD.js");
...
var PhantomWallet = class _PhantomWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        PhantomConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-phantom.browser.esm-7J7B5JR4.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          RainbowConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-rainbow.browser.esm-BF3ISAEM.js");
...
var SafeWallet = class _SafeWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        SafeConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-safe.browser.esm-FAWHQOQE.js");
...
var SmartWallet = class _SmartWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-smart-wallet.browser.esm-GS2HGBN7.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          TrustConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-trust.browser.esm-MLSP7DI4.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          ZerionConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-zerion.browser.esm-NS3C4XE3.js");
...
var TokenBoundSmartWallet = class extends SmartWallet {
  ...
  async getConnector() {
    if (!this.tbaConnector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-token-bound-smart-wallet.browser.esm-5WSYCE2J.js");
...
//# sourceMappingURL=chunk-FHX5LRMD.js.map
