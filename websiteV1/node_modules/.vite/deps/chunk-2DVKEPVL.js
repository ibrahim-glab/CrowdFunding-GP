...
// node_modules/@thirdweb-dev/sdk/dist/QueryParams-c67b6cd4.browser.esm.js
init_lib();
...
async function fetchTokenMetadataForContract(contractAddress, provider, tokenId, storage) {
  let uri;
  const ERC165MetadataAbi = (await import("./IERC165-QKVOX3HC.js")).default;
  ...
  if (isERC721) {
    const ERC721MetadataAbi = (await import("./IERC721Metadata-245U5PEW.js")).default;
    const erc721 = new Contract(contractAddress, ERC721MetadataAbi, provider);
    uri = await erc721.tokenURI(tokenId);
  } else if (isERC1155) {
    const ERC1155MetadataAbi = (await import("./IERC1155Metadata-DD65HQXN.js")).default;
...
//# sourceMappingURL=chunk-2DVKEPVL.js.map
