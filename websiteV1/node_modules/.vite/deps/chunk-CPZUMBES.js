...
var HttpRpcClient = class {
  constructor(bundlerUrl, entryPointAddress, chainId, clientId, secretKey) {
    ...
    this.userOpJsonRpcProvider = new lib_exports2.JsonRpcProvider({
      url: this.bundlerUrl,
      headers
    }, {
...
var BaseAccountAPI = class {
  ...
  async getUserOpReceipt(userOpHash) {
    ...
    let interval = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 2e3;
...
//# sourceMappingURL=chunk-CPZUMBES.js.map
