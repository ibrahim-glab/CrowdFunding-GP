...
import {
  IERC721_default
} from "./chunk-NI75G64R.js";
import {
  IERC721Metadata_default
} from "./chunk-NXQSFSYO.js";
import {
  IERC1155_default
} from "./chunk-7JTQECNY.js";
import {
  IERC1155Metadata_default
} from "./chunk-UHBWZKE6.js";
import {
  IERC20_default
} from "./chunk-FNDLL6VS.js";
import {
  IERC20Metadata_default
} from "./chunk-6D6UEHK3.js";
import {
  c1220,
  c137,
  c220,
...
async function getMetadataUriFromMultichainRegistry(address, chainId, sdkOptions) {
  var _a;
  const TWRegistryABI = (await import("./TWMultichainRegistryLogic-LNQP2CVA.js")).default;
...
Expected function signature: ${functions[0].signature}`);
  ...
  async enginePrepareRequest(transaction) {
    ...
    if (transaction.functionName === "approve" && transaction.functionArgs.length === 2) {
      ...
      const ForwarderABI = (await import("./Forwarder-R6SOEZY3.js")).default;
...
var EditionDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [abi, contract, _network] = await Promise.all([EditionDropInitializer.getAbi(address, provider2, storage), import("./edition-drop-d7a823c2.browser.esm-DSDDKBEE.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return !contractInfo || contractInfo.version > 2 ? (await import("./DropERC1155-D3AMTGBY.js")).default : (await import("./DropERC1155_V2-BMVM5WSB.js")).default;
  }
};
var EditionInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([EditionInitializer.getAbi(address, provider2, storage), import("./edition-da051f66.browser.esm-RQMSX6FO.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./TokenERC1155-TUDBY3KC.js")).default;
  }
};
var MarketplaceInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceInitializer.getAbi(address, provider2, storage), import("./marketplace-3f9edf56.browser.esm-GDII2NBH.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./Marketplace-2Z2R46PB.js")).default;
  }
};
var MarketplaceV3Initializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceV3Initializer.getAbi(address, provider2, storage, options), import("./marketplacev3-d4336a42.browser.esm-7LA5LS3W.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage, options) => {
    ...
    const localAbi = (await import("./MarketplaceV3-APQ3Y5XD.js")).default;
...
var MultiwrapInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MultiwrapInitializer.getAbi(address, provider2, storage), import("./multiwrap-cff091c3.browser.esm-DBJ4XZVE.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./Multiwrap-QDTNG7CE.js")).default;
  }
};
var NFTCollectionInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTCollectionInitializer.getAbi(address, provider2, storage), import("./nft-collection-083c9a68.browser.esm-IV55SAXR.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./TokenERC721-LYVWGYPF.js")).default;
  }
};
var NFTDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTDropInitializer.getAbi(address, provider2, storage), import("./nft-drop-4f7bc814.browser.esm-EGUJBJGX.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    const contractInfo = await getContractInfo(address, provider2);
    return !contractInfo || contractInfo.version > 3 ? (await import("./DropERC721-WGKPG6AU.js")).default : (await import("./DropERC721_V3-Z5I32L7L.js")).default;
  }
};
var PackInitializer = {
  name: "Pack",
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([PackInitializer.getAbi(address, provider2, storage), import("./pack-91228b06.browser.esm-A5LRIPW3.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return AbiSchema.parse((await import("./Pack-UOO6QBO3.js")).default || []);
  }
};
var SignatureDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SignatureDropInitializer.getAbi(address, provider2, storage), import("./signature-drop-fae5d268.browser.esm-DB4LCT7L.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    const contractInfo = await getContractInfo(address, provider2);
    return !contractInfo || contractInfo.version > 4 ? (await import("./SignatureDrop-4PSC56JV.js")).default : (await import("./SignatureDrop_V4-7Q5TTSCQ.js")).default;
  }
};
var SplitInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SplitInitializer.getAbi(address, provider2, storage), import("./split-662e0eb9.browser.esm-HW4AZE73.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./Split-OKTL54AV.js")).default;
  }
};
var TokenDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenDropInitializer.getAbi(address, provider2, storage), import("./token-drop-60b3a7e1.browser.esm-4VDUP7RO.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    const contractInfo = await getContractInfo(address, provider2);
    return !contractInfo || contractInfo.version > 2 ? (await import("./DropERC20-K7S4ZXT4.js")).default : (await import("./DropERC20_V2-IZMJDGP5.js")).default;
  }
};
var TokenInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenInitializer.getAbi(address, provider2, storage), import("./token-f628c2eb.browser.esm-SOHG7LOU.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./TokenERC20-HQBCWMB5.js")).default;
  }
};
var VoteInitializer = {
  name: "VoteERC20",
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([VoteInitializer.getAbi(address, provider2, storage), import("./vote-372766c9.browser.esm-ULWQXW5M.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./VoteERC20-UL6UYN4D.js")).default;
  }
};
...
@thirdweb-dev/crypto/dist/thirdweb-dev-crypto.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4UWMVSMF.js.map
