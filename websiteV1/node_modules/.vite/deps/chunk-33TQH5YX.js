...
var import_chacha20poly1305, import_hkdf, import_random, import_sha256, fe, import_time, import_window_getters, import_window_metadata, M, K, J, p, F, H, Q, _, Dn, Te, Z, X, Bn, Ue, Gn, Wn, _e, $e, Ce, m, De, He, bt, Nt, Ot, qe, St, wt, Be, It, Tt, nn, tn, ae, sr;
var init_index_es = __esm({
  "node_modules/@walletconnect/utils/dist/index.es.js"() {
    ...
    _e = (e, n2, t) => n2 in e ? Bn(e, n2, { enumerable: true, configurable: true, writable: true, value: t }) : e[n2] = t;
    $e = (e, n2) => {
      for (var t in n2 || (n2 = {}))
    ...
    Be = (e, n2, t) => n2 in e ? bt(e, n2, { enumerable: true, configurable: true, writable: true, value: t }) : e[n2] = t;
    It = (e, n2) => {
      for (var t in n2 || (n2 = {}))
    ...
    tn = { NOT_INITIALIZED: { message: "Not initialized.", code: 1 }, NO_MATCHING_KEY: { message: "No matching key.", code: 2 }, RESTORE_WILL_OVERRIDE: { message: "Restore will override.", code: 3 }, RESUBSCRIBED: { message: "Resubscribed.", code: 4 }, MISSING_OR_INVALID: { message: "Missing or invalid.", code: 5 }, EXPIRED: { message: "Expired.", code: 6 }, UNKNOWN_TYPE: { message: "Unknown type.", code: 7 }, MISMATCHED_TOPIC: { message: "Mismatched topic.", code: 8 }, NON_CONFORMING_NAMESPACES: { message: "Non conforming namespaces.", code: 9 } };
    ae = {};
    sr = class {
      static get(n2) {
        return ae[n2];
...
var x, z, D2, E, _2, l, c, K2, N2, y, O2, j2, h;
...
var require_heartbeat = __commonJS({
  "node_modules/@walletconnect/heartbeat/dist/cjs/types/heartbeat.js"(exports) {
    ...
    var events_1 = (init_esm4(), __toCommonJS(esm_exports2));
...
var import_events2, n, h2, a, u, g2, p2, d, E2, y2, v, b, w2;
...
var ed25519, import_random2, import_time2;
var init_api = __esm({
  "node_modules/@walletconnect/relay-auth/dist/esm/api.js"() {
...
var import_events4, w3, b2, a2, h3, S2, f;
var init_index_es4 = __esm({
  "node_modules/@walletconnect/jsonrpc-ws-connection/dist/index.es.js"() {
    import_events4 = __toESM(require_events());
    init_esm3();
    init_esm();
    w3 = () => typeof WebSocket < "u" ? WebSocket : typeof global < "u" && typeof global.WebSocket < "u" ? global.WebSocket : typeof window < "u" && typeof window.WebSocket < "u" ? window.WebSocket : typeof self < "u" && typeof self.WebSocket < "u" ? self.WebSocket : require_browser3();
...
var import_events5, import_heartbeat, import_logger, import_time3, import_lodash, import_isomorphic_unfetch, Ji, Xi, Ne, Wi, Qi, Zi, es, ts, Ue2, is, W2, B2, ss, rs, g3, ns, os, as, hs, cs, us, ls, ds, gs, ps, Ds, ys, ms, bs, fs, Es, ws, vs, Is, Cs, Rs, _s, Ts, Ss, Ps, xs, Os, As, zs, Ns, Us, Ls, Le, $s, Fs, Ks, Bs, Vs, $e2, qs, js, Gs, Ys, Hs, Me2, Js, Xs, Ws, Qs, Zs, er2, tr2, ir, sr2, rr2, nr2, ke2, Ke2, Be2, ce2, or2, Ve2, ar, qe2, hr, cr, ur, je, lr, Ge2, dr, gr, pr, Ye, Xe2, ue2, yr, le2, We2, Q2, O3, Qe2, Ze2, et, de2, tt, it, st, rt2, nt, ot2, at2, ht2, ct, ge2, pe, ut2, D3, lt2, P, dt2, gt2, pt2, Dt, yt2, w4, mt2, bt2, ft2, Et2, wt2, $2, V2, R2, vt2, It2, Ct, v2, Rt2, Z2, F2, ee2, _t, Tt2, St2, Pt2, xt2, Ot2, vr, Ir, Cr, Rr, _r, At, Tr, Sr, zt2, q, De2, Nt2, Pr, Ut, xr, Or, Lt2, Ar, $t, zr, Ft2, Nr, Ur, Mt2, kt, Kt2, Bt2, Vt, qt2, jt, Gt2, Lr, Yt2, $r, Fr, Ht2, Jt2, te2, Mr;
var init_index_es5 = __esm({
  "node_modules/@walletconnect/core/dist/index.es.js"() {
    ...
    import_isomorphic_unfetch = __toESM(require_browser4());
    Ji = Hi;
    Xi = Ji;
    Ne = (n2) => {
    ...
    Wi = (n2) => new TextEncoder().encode(n2);
    Qi = (n2) => new TextDecoder().decode(n2);
    Zi = class {
      constructor(e, t, i2) {
    ...
    Ue2 = (n2, e) => new ts({ ...n2.decoders || { [n2.prefix]: n2 }, ...e.decoders || { [e.prefix]: e } });
    is = class {
    ...
    W2 = ({ name: n2, prefix: e, encode: t, decode: i2 }) => new is(n2, e, t, i2);
    B2 = ({ prefix: n2, name: e, alphabet: t }) => {
    ...
    g3 = ({ name: n2, prefix: e, bitsPerChar: t, alphabet: i2 }) => W2({ prefix: e, name: n2, encode(s) {
      return rs(s, i2, t);
    }, decode(s) {
      return ss(s, i2, t, n2);
    } });
    ns = W2({ prefix: "\0", name: "identity", encode: (n2) => Qi(n2), decode: (n2) => Wi(n2) });
    os = Object.freeze({ __proto__: null, identity: ns });
    as = g3({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 });
    hs = Object.freeze({ __proto__: null, base2: as });
    cs = g3({ prefix: "7", name: "base8", alphabet: "01234567", bitsPerChar: 3 });
    us = Object.freeze({ __proto__: null, base8: cs });
    ls = B2({ prefix: "9", name: "base10", alphabet: "0123456789" });
    ds = Object.freeze({ __proto__: null, base10: ls });
    gs = g3({ prefix: "f", name: "base16", alphabet: "0123456789abcdef", bitsPerChar: 4 });
    ps = g3({ prefix: "F", name: "base16upper", alphabet: "0123456789ABCDEF", bitsPerChar: 4 });
    Ds = Object.freeze({ __proto__: null, base16: gs, base16upper: ps });
    ys = g3({ prefix: "b", name: "base32", alphabet: "abcdefghijklmnopqrstuvwxyz234567", bitsPerChar: 5 });
    ms = g3({ prefix: "B", name: "base32upper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567", bitsPerChar: 5 });
    bs = g3({ prefix: "c", name: "base32pad", alphabet: "abcdefghijklmnopqrstuvwxyz234567=", bitsPerChar: 5 });
    fs = g3({ prefix: "C", name: "base32padupper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567=", bitsPerChar: 5 });
    Es = g3({ prefix: "v", name: "base32hex", alphabet: "0123456789abcdefghijklmnopqrstuv", bitsPerChar: 5 });
    ws = g3({ prefix: "V", name: "base32hexupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV", bitsPerChar: 5 });
    vs = g3({ prefix: "t", name: "base32hexpad", alphabet: "0123456789abcdefghijklmnopqrstuv=", bitsPerChar: 5 });
    Is = g3({ prefix: "T", name: "base32hexpadupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV=", bitsPerChar: 5 });
    Cs = g3({ prefix: "h", name: "base32z", alphabet: "ybndrfg8ejkmcpqxot1uwisza345h769", bitsPerChar: 5 });
    Rs = Object.freeze({ __proto__: null, base32: ys, base32upper: ms, base32pad: bs, base32padupper: fs, base32hex: Es, base32hexupper: ws, base32hexpad: vs, base32hexpadupper: Is, base32z: Cs });
    _s = B2({ prefix: "k", name: "base36", alphabet: "0123456789abcdefghijklmnopqrstuvwxyz" });
    Ts = B2({ prefix: "K", name: "base36upper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ" });
    Ss = Object.freeze({ __proto__: null, base36: _s, base36upper: Ts });
    Ps = B2({ name: "base58btc", prefix: "z", alphabet: "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz" });
    xs = B2({ name: "base58flickr", prefix: "Z", alphabet: "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ" });
    Os = Object.freeze({ __proto__: null, base58btc: Ps, base58flickr: xs });
    As = g3({ prefix: "m", name: "base64", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", bitsPerChar: 6 });
    zs = g3({ prefix: "M", name: "base64pad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", bitsPerChar: 6 });
    Ns = g3({ prefix: "u", name: "base64url", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", bitsPerChar: 6 });
    Us = g3({ prefix: "U", name: "base64urlpad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_=", bitsPerChar: 6 });
    Ls = Object.freeze({ __proto__: null, base64: As, base64pad: zs, base64url: Ns, base64urlpad: Us });
    Le = Array.from("🚀🪐☄🛰🌌🌑🌒🌓🌔🌕🌖🌗🌘🌍🌏🌎🐉☀💻🖥💾💿😂❤😍🤣😊🙏💕😭😘👍😅👏😁🔥🥰💔💖💙😢🤔😆🙄💪😉☺👌🤗💜😔😎😇🌹🤦🎉💞✌✨🤷😱😌🌸🙌😋💗💚😏💛🙂💓🤩😄😀🖤😃💯🙈👇🎶😒🤭❣😜💋👀😪😑💥🙋😞😩😡🤪👊🥳😥🤤👉💃😳✋😚😝😴🌟😬🙃🍀🌷😻😓⭐✅🥺🌈😈🤘💦✔😣🏃💐☹🎊💘😠☝😕🌺🎂🌻😐🖕💝🙊😹🗣💫💀👑🎵🤞😛🔴😤🌼😫⚽🤙☕🏆🤫👈😮🙆🍻🍃🐶💁😲🌿🧡🎁⚡🌞🎈❌✊👋😰🤨😶🤝🚶💰🍓💢🤟🙁🚨💨🤬✈🎀🍺🤓😙💟🌱😖👶🥴▶➡❓💎💸⬇😨🌚🦋😷🕺⚠🙅😟😵👎🤲🤠🤧📌🔵💅🧐🐾🍒😗🤑🌊🤯🐷☎💧😯💆👆🎤🙇🍑❄🌴💣🐸💌📍🥀🤢👅💡💩👐📸👻🤐🤮🎼🥵🚩🍎🍊👼💍📣🥂");
    $s = Le.reduce((n2, e, t) => (n2[t] = e, n2), []);
    Fs = Le.reduce((n2, e, t) => (n2[e.codePointAt(0)] = t, n2), []);
    Ks = W2({ prefix: "🚀", name: "base256emoji", encode: Ms, decode: ks });
    Bs = Object.freeze({ __proto__: null, base256emoji: Ks });
    Vs = Fe;
    $e2 = 128;
    qs = 127;
    js = ~qs;
    ...
    nr2 = { encode: Vs, decode: Ys, encodingLength: rr2 };
    ke2 = nr2;
    Ke2 = (n2, e, t = 0) => (ke2.encode(n2, e, t), e);
    Be2 = (n2) => ke2.encodingLength(n2);
    ce2 = (n2, e) => {
    ...
    Ve2 = ({ name: n2, code: e, encode: t }) => new ar(n2, e, t);
    ar = class {
      constructor(e, t, i2) {
    ...
    qe2 = (n2) => async (e) => new Uint8Array(await crypto.subtle.digest(n2, e));
    hr = Ve2({ name: "sha2-256", code: 18, encode: qe2("SHA-256") });
    cr = Ve2({ name: "sha2-512", code: 19, encode: qe2("SHA-512") });
    ur = Object.freeze({ __proto__: null, sha256: hr, sha512: cr });
    je = 0;
    lr = "identity";
    Ge2 = Ne;
    dr = (n2) => ce2(je, Ge2(n2));
    gr = { code: je, name: lr, encode: Ge2, digest: dr };
    pr = Object.freeze({ __proto__: null, identity: gr });
    new TextEncoder(), new TextDecoder();
    Ye = { ...os, ...hs, ...us, ...ds, ...Ds, ...Rs, ...Ss, ...Os, ...Ls, ...Bs };
    ({ ...ur, ...pr });
    Xe2 = Je("utf8", "u", (n2) => "u" + new TextDecoder("utf8").decode(n2), (n2) => new TextEncoder().encode(n2.substring(1)));
    ue2 = Je("ascii", "a", (n2) => {
      let e = "a";
    ...
    yr = { utf8: Xe2, "utf-8": Xe2, hex: Ye.base16, latin1: ue2, ascii: ue2, binary: ue2, ...Ye };
    le2 = "wc";
    We2 = 2;
    Q2 = "core";
    O3 = `${le2}@2:${Q2}:`;
    ...
    Ze2 = { database: ":memory:" };
    et = "crypto";
    de2 = "client_ed25519_seed";
    tt = import_time3.ONE_DAY;
    it = "keychain";
    st = "0.3";
    rt2 = "messages";
    nt = "0.3";
    ot2 = import_time3.SIX_HOURS;
    at2 = "publisher";
    ht2 = "irn";
    ct = "error";
    ...
    dt2 = import_time3.ONE_SECOND;
    gt2 = "2.11.1";
    pt2 = 1e4;
    Dt = "0.3";
    yt2 = "WALLETCONNECT_CLIENT_ID";
    w4 = { created: "subscription_created", deleted: "subscription_deleted", expired: "subscription_expired", disabled: "subscription_disabled", sync: "subscription_sync", resubscribed: "subscription_resubscribed" };
    mt2 = "subscription";
    bt2 = "0.3";
    ft2 = import_time3.FIVE_SECONDS * 1e3;
    Et2 = "pairing";
    wt2 = "0.3";
    $2 = { wc_pairingDelete: { req: { ttl: import_time3.ONE_DAY, prompt: false, tag: 1e3 }, res: { ttl: import_time3.ONE_DAY, prompt: false, tag: 1001 } }, wc_pairingPing: { req: { ttl: import_time3.THIRTY_SECONDS, prompt: false, tag: 1002 }, res: { ttl: import_time3.THIRTY_SECONDS, prompt: false, tag: 1003 } }, unregistered_method: { req: { ttl: import_time3.ONE_DAY, prompt: false, tag: 0 }, res: { ttl: import_time3.ONE_DAY, prompt: false, tag: 0 } } };
    V2 = { create: "pairing_create", expire: "pairing_expire", delete: "pairing_delete", ping: "pairing_ping" };
    R2 = { created: "history_created", updated: "history_updated", deleted: "history_deleted", sync: "history_sync" };
    vt2 = "history";
    It2 = "0.3";
    Ct = "expirer";
    v2 = { created: "expirer_created", deleted: "expirer_deleted", expired: "expirer_expired", sync: "expirer_sync" };
    Rt2 = "0.3";
    Z2 = "verify-api";
    F2 = "https://verify.walletconnect.com";
    ee2 = "https://verify.walletconnect.org";
    _t = [F2, ee2];
    Tt2 = "echo";
    St2 = "https://echo.walletconnect.com";
    Pt2 = class {
      constructor(e, t) {
    ...
    zt2 = (n2, e, t) => e in n2 ? Cr(n2, e, { enumerable: true, configurable: true, writable: true, value: t }) : n2[e] = t;
    q = (n2, e) => {
      for (var t in e || (e = {}))
    ...
    Lt2 = (n2, e, t) => e in n2 ? Pr(n2, e, { enumerable: true, configurable: true, writable: true, value: t }) : n2[e] = t;
    Ar = (n2, e) => {
      for (var t in e || (e = {}))
    ...
    Ft2 = Object.getOwnPropertySymbols;
    Nr = Object.prototype.hasOwnProperty;
    Ur = Object.prototype.propertyIsEnumerable;
    Mt2 = (n2, e, t) => e in n2 ? zr(n2, e, { enumerable: true, configurable: true, writable: true, value: t }) : n2[e] = t;
    kt = (n2, e) => {
      for (var t in e || (e = {}))
    ...
    Yt2 = Object.getOwnPropertySymbols;
    $r = Object.prototype.hasOwnProperty;
    Fr = Object.prototype.propertyIsEnumerable;
    Ht2 = (n2, e, t) => e in n2 ? Lr(n2, e, { enumerable: true, configurable: true, writable: true, value: t }) : n2[e] = t;
    Jt2 = (n2, e) => {
      for (var t in e || (e = {}))
...
var import_logger2, import_events6, import_time4, J2, F3, X3, G3, M2, H2, oe2, ae2, ce3, L3, le3, R3, U3, I, pe2, he3, as2, cs2, ls2, de3, ps2, hs2, ue3, g4, D4, ds2, us2, ge3, gs2, Q3, ws2, ms2;
var init_index_es6 = __esm({
  "node_modules/@walletconnect/sign-client/dist/index.es.js"() {
    ...
    X3 = "client";
    G3 = `${J2}@${F3}:${X3}:`;
    M2 = { name: X3, logger: "error", controller: false, relayUrl: "wss://relay.walletconnect.com" };
    H2 = "WALLETCONNECT_DEEPLINK_CHOICE";
    oe2 = "proposal";
    ae2 = "Proposal expired";
    ce3 = "session";
    L3 = import_time4.SEVEN_DAYS;
    le3 = "engine";
    R3 = { wc_sessionPropose: { req: { ttl: import_time4.FIVE_MINUTES, prompt: true, tag: 1100 }, res: { ttl: import_time4.FIVE_MINUTES, prompt: false, tag: 1101 } }, wc_sessionSettle: { req: { ttl: import_time4.FIVE_MINUTES, prompt: false, tag: 1102 }, res: { ttl: import_time4.FIVE_MINUTES, prompt: false, tag: 1103 } }, wc_sessionUpdate: { req: { ttl: import_time4.ONE_DAY, prompt: false, tag: 1104 }, res: { ttl: import_time4.ONE_DAY, prompt: false, tag: 1105 } }, wc_sessionExtend: { req: { ttl: import_time4.ONE_DAY, prompt: false, tag: 1106 }, res: { ttl: import_time4.ONE_DAY, prompt: false, tag: 1107 } }, wc_sessionRequest: { req: { ttl: import_time4.FIVE_MINUTES, prompt: true, tag: 1108 }, res: { ttl: import_time4.FIVE_MINUTES, prompt: false, tag: 1109 } }, wc_sessionEvent: { req: { ttl: import_time4.FIVE_MINUTES, prompt: true, tag: 1110 }, res: { ttl: import_time4.FIVE_MINUTES, prompt: false, tag: 1111 } }, wc_sessionDelete: { req: { ttl: import_time4.ONE_DAY, prompt: false, tag: 1112 }, res: { ttl: import_time4.ONE_DAY, prompt: false, tag: 1113 } }, wc_sessionPing: { req: { ttl: import_time4.THIRTY_SECONDS, prompt: false, tag: 1114 }, res: { ttl: import_time4.THIRTY_SECONDS, prompt: false, tag: 1115 } } };
    U3 = { min: import_time4.FIVE_MINUTES, max: import_time4.SEVEN_DAYS };
    I = { idle: "IDLE", active: "ACTIVE" };
    pe2 = "request";
    he3 = ["wc_sessionPropose", "wc_sessionRequest", "wc_authRequest"];
    as2 = Object.defineProperty;
    cs2 = Object.defineProperties;
    ls2 = Object.getOwnPropertyDescriptors;
    de3 = Object.getOwnPropertySymbols;
    ps2 = Object.prototype.hasOwnProperty;
    hs2 = Object.prototype.propertyIsEnumerable;
    ue3 = (w5, r, e) => r in w5 ? as2(w5, r, { enumerable: true, configurable: true, writable: true, value: e }) : w5[r] = e;
    g4 = (w5, r) => {
      for (var e in r || (r = {}))
    ...
    D4 = (w5, r) => cs2(w5, ls2(r));
    ds2 = class extends w2 {
      constructor(r) {
        super(r), this.name = le3, this.events = new import_events6.default(), this.initialized = false, this.ignoredPayloadTypes = [_], this.requestQueue = { state: I.idle, queue: [] }, this.sessionRequestQueue = { state: I.idle, queue: [] }, this.requestQueueDelay = import_time4.ONE_SECOND, this.init = async () => {
          ...
          const h4 = await this.client.core.crypto.generateKeyPair(), N4 = R3.wc_sessionPropose.req.ttl || import_time4.FIVE_MINUTES, m2 = pt(N4), f2 = g4({ requiredNamespaces: i2, optionalNamespaces: n2, relays: a3 ?? [{ protocol: ht2 }], proposer: { publicKey: h4, metadata: this.client.metadata }, expiryTimestamp: m2 }, o && { sessionProperties: o }), { reject: k3, resolve: O4, done: we } = at(N4, ae2);
          ...
          const f2 = g4({ relay: { protocol: t ?? "irn" }, namespaces: i2, pairingTopic: a3, controller: { publicKey: h4, metadata: this.client.metadata }, expiry: pt(L3) }, n2 && { sessionProperties: n2 });
...
export {
  ...
  Kt2,
  Mr,
  init_index_es5 as init_index_es2,
  ae2 as ae,
  Q3 as Q,
  ws2 as ws,
  ms2 as ms,
  init_index_es6 as init_index_es3
};
//# sourceMappingURL=chunk-33TQH5YX.js.map
