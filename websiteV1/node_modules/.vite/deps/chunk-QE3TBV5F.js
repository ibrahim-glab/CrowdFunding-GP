...
import {
  ...
  getAnalyticsHeaders,
  require_dist
} from "./chunk-4KY2XURA.js";
import {
  ThirdwebSDK
} from "./chunk-YGRF7CTW.js";
import {
...
var BloctoWallet = class _BloctoWallet extends AbstractClientWallet {
  ...
  async initConnector() {
    ...
    const {
      BloctoConnector
    } = await import("./thirdweb-dev-wallets-evm-connectors-blocto.browser.esm-H6OP6XCP.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          MetaMaskConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-metamask.browser.esm-VDGTPQFH.js");
        ...
        } = await import("./thirdweb-dev-wallets-evm-connectors-wallet-connect.browser.esm-PU5A27WJ.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          OKXConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-okx.browser.esm-RO7ZHOTP.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          CoreWalletConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-core-wallet.browser.esm-SIRIOL2F.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          OneKeyConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-onekey.browser.esm-QO2HLWRS.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        ...
        } = await import("./thirdweb-dev-wallets-evm-connectors-crypto-defi-wallet.browser.esm-MONHOYIJ.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          RabbyConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-rabby.browser.esm-WEPXEO2M.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          Coin98Connector
        } = await import("./thirdweb-dev-wallets-evm-connectors-coin98.browser.esm-LYSAZPNW.js");
...
var PaperWallet = class _PaperWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-paper.browser.esm-Q5RVDOQY.js");
...
var CoinbaseWallet = class _CoinbaseWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-coinbase-wallet.browser.esm-K5STWLQW.js");
...
var EmbeddedWallet = class _EmbeddedWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-embedded-wallet.browser.esm-THIT6GLW.js");
...
var FrameWallet = class _FrameWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        FrameConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-frame.browser.esm-MCJ26FAJ.js");
...
var InjectedWallet = class _InjectedWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        InjectedConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-injected.browser.esm-W34LPGAV.js");
...
var LocalWallet = class _LocalWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-local-wallet.browser.esm-MM4LROVF.js");
...
var SignerWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        SignerConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-signer.browser.esm-5XWXQQPL.js");
      if (!this.signer) {
...
var MagicLink = class _MagicLink extends AbstractClientWallet {
  ...
  async initializeConnector() {
    const {
      MagicAuthConnector
    } = await import("./thirdweb-dev-wallets-evm-connectors-magic.browser.esm-ZI3WU5IL.js");
...
var XDEFIWallet = class _XDEFIWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        XDEFIConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-xdefi.browser.esm-CSY65CQD.js");
...
var PhantomWallet = class _PhantomWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        PhantomConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-phantom.browser.esm-GOVP6LEH.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          RainbowConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-rainbow.browser.esm-C36CCIB6.js");
...
var SafeWallet = class _SafeWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        SafeConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-safe.browser.esm-35WKYW7J.js");
...
var SmartWallet = class _SmartWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-smart-wallet.browser.esm-JNMW4VRB.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          TrustConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-trust.browser.esm-5VIEJUCD.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          ZerionConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-zerion.browser.esm-LY5Y4JSF.js");
...
var TokenBoundSmartWallet = class extends SmartWallet {
  ...
  async getConnector() {
    if (!this.tbaConnector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-token-bound-smart-wallet.browser.esm-TVSV7GUG.js");
...
//# sourceMappingURL=chunk-QE3TBV5F.js.map
