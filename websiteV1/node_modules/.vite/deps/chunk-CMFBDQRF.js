...
import {
  ...
  getAnalyticsHeaders,
  require_dist
} from "./chunk-6D4T77JE.js";
import {
  ThirdwebSDK
} from "./chunk-OAS74USQ.js";
import {
...
var BloctoWallet = class _BloctoWallet extends AbstractClientWallet {
  ...
  async initConnector() {
    ...
    const {
      BloctoConnector
    } = await import("./thirdweb-dev-wallets-evm-connectors-blocto.browser.esm-ESFE3WAU.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          MetaMaskConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-metamask.browser.esm-DZTL7DEF.js");
        ...
        } = await import("./thirdweb-dev-wallets-evm-connectors-wallet-connect.browser.esm-OSGQ7HHZ.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          OKXConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-okx.browser.esm-GG2FI2UG.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          CoreWalletConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-core-wallet.browser.esm-VI66J5T2.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          OneKeyConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-onekey.browser.esm-IJCMU3UZ.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        ...
        } = await import("./thirdweb-dev-wallets-evm-connectors-crypto-defi-wallet.browser.esm-HPTOTQQZ.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          RabbyConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-rabby.browser.esm-3CDH6RSB.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          Coin98Connector
        } = await import("./thirdweb-dev-wallets-evm-connectors-coin98.browser.esm-26UQMZHA.js");
...
var PaperWallet = class _PaperWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-paper.browser.esm-AT65ZBE4.js");
...
var CoinbaseWallet = class _CoinbaseWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-coinbase-wallet.browser.esm-N7JQEDOD.js");
...
var EmbeddedWallet = class _EmbeddedWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-embedded-wallet.browser.esm-MBS4IC7Q.js");
...
var FrameWallet = class _FrameWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        FrameConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-frame.browser.esm-HIF2T3KV.js");
...
var InjectedWallet = class _InjectedWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        InjectedConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-injected.browser.esm-CNDP3VXG.js");
...
var LocalWallet = class _LocalWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-local-wallet.browser.esm-XLZAU3XJ.js");
...
var SignerWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        SignerConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-signer.browser.esm-BVI4Z5IJ.js");
      if (!this.signer) {
...
var MagicLink = class _MagicLink extends AbstractClientWallet {
  ...
  async initializeConnector() {
    const {
      MagicAuthConnector
    } = await import("./thirdweb-dev-wallets-evm-connectors-magic.browser.esm-NXB72GTK.js");
...
var XDEFIWallet = class _XDEFIWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        XDEFIConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-xdefi.browser.esm-ZUVAMG4C.js");
...
var PhantomWallet = class _PhantomWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        PhantomConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-phantom.browser.esm-NAZJ5EZC.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          RainbowConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-rainbow.browser.esm-T5XAYM5K.js");
...
var SafeWallet = class _SafeWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        SafeConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-safe.browser.esm-UMCPCQBD.js");
...
var SmartWallet = class _SmartWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-smart-wallet.browser.esm-2764VAMW.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          TrustConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-trust.browser.esm-NBOCST2R.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          ZerionConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-zerion.browser.esm-YA5EFDUV.js");
...
var TokenBoundSmartWallet = class extends SmartWallet {
  ...
  async getConnector() {
    if (!this.tbaConnector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-token-bound-smart-wallet.browser.esm-R7ACG7BO.js");
...
//# sourceMappingURL=chunk-CMFBDQRF.js.map
