...
async function fetchTokenMetadataForContract(contractAddress, provider, tokenId, storage) {
  let uri;
  const ERC165MetadataAbi = (await import("./IERC165-DTZRIIWR.js")).default;
  ...
  if (isERC721) {
    const ERC721MetadataAbi = (await import("./IERC721Metadata-552WACFG.js")).default;
    const erc721 = new Contract(contractAddress, ERC721MetadataAbi, provider);
    uri = await erc721.tokenURI(tokenId);
  } else if (isERC1155) {
    const ERC1155MetadataAbi = (await import("./IERC1155Metadata-4C7CVQJZ.js")).default;
...
//# sourceMappingURL=chunk-TVBEQ3OD.js.map
