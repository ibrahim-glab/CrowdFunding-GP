...
var ModelViewer = (0, import_react12.lazy)(() => import("./ModelViewer-ad6f3167.browser.esm-3NPKDEE6.js"));
var PlayButton = (_ref) => {
  let {
    onClick,
    isPlaying
  ...
  (0, import_react12.useEffect)(() => {
    ...
    const preloadEmbeddedWallet = async () => {
      ...
      if (hasEmbeddedWallet && restProps.clientId) {
        const {
          EmbeddedWalletSdk
        } = await import("./thirdweb-dev-wallets.browser.esm-7YEHL2QQ.js");
...
function useRainbowWallet() {
  ...
  return (0, import_react12.useCallback)(async (connectOptions) => {
    const {
      rainbowWallet
    } = await import("./safeChainSlug-27254a82.browser.esm-3RSOFI55.js").then(function(n) {
      return n.R;
    });
...
function useFrameWallet() {
  ...
  return (0, import_react12.useCallback)(async (connectOptions) => {
    const {
      frameWallet
    } = await import("./frameWallet-eddfe811.browser.esm-TCEF2L5D.js");
...
function useBloctoWallet() {
  ...
  return (0, import_react12.useCallback)(async (options) => {
    const {
      bloctoWallet
    } = await import("./bloctoWallet-4cc043fb.browser.esm-GKU55IYU.js");
...
function usePaperWallet() {
  ...
  return (0, import_react12.useCallback)(async (options) => {
    ...
    } = await import("./paperWallet-6bb05b7e.browser.esm-NLLLT6JM.js");
...
function useWalletConnectV1() {
  ...
  return (0, import_react12.useCallback)(async (options) => {
    const {
      walletConnectV1
    } = await import("./walletConnectV1-ec1c5354.browser.esm-M3PVXBAJ.js");
...
//# sourceMappingURL=chunk-OU2HD3YZ.js.map
