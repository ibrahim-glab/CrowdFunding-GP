...
var ModelViewer = (0, import_react12.lazy)(() => import("./ModelViewer-ad6f3167.browser.esm-6O56VYUY.js"));
var PlayButton = (_ref) => {
  let {
    onClick,
    isPlaying
  ...
  (0, import_react12.useEffect)(() => {
    ...
    const preloadEmbeddedWallet = async () => {
      ...
      if (hasEmbeddedWallet && restProps.clientId) {
        const {
          EmbeddedWalletSdk
        } = await import("./thirdweb-dev-wallets.browser.esm-MQ4HUNPZ.js");
...
function useRainbowWallet() {
  ...
  return (0, import_react12.useCallback)(async (connectOptions) => {
    const {
      rainbowWallet
    } = await import("./safeChainSlug-27254a82.browser.esm-P7NAMXLZ.js").then(function(n) {
      return n.R;
    });
...
function useFrameWallet() {
  ...
  return (0, import_react12.useCallback)(async (connectOptions) => {
    const {
      frameWallet
    } = await import("./frameWallet-eddfe811.browser.esm-2CCSYEKM.js");
...
function useBloctoWallet() {
  ...
  return (0, import_react12.useCallback)(async (options) => {
    const {
      bloctoWallet
    } = await import("./bloctoWallet-4cc043fb.browser.esm-SQWCTCA3.js");
...
function usePaperWallet() {
  ...
  return (0, import_react12.useCallback)(async (options) => {
    ...
    } = await import("./paperWallet-6bb05b7e.browser.esm-T2KTUYSV.js");
...
function useWalletConnectV1() {
  ...
  return (0, import_react12.useCallback)(async (options) => {
    const {
      walletConnectV1
    } = await import("./walletConnectV1-ec1c5354.browser.esm-QKFO6C6I.js");
...
//# sourceMappingURL=chunk-FJMYCS3A.js.map
