...
_defineProperty(Web3Api, "native", {
  ...
  getInternalTransactions: async (options = {}) => Web3Api.fetch({
    endpoint: {
      "method": "GET",
      "group": "native",
  ...
  getTransactionVerbose: async (options = {}) => Web3Api.fetch({
    endpoint: {
      "method": "GET",
      "group": "native",
...
_defineProperty(Web3Api, "account", {
  ...
  getTransactionsVerbose: async (options = {}) => Web3Api.fetch({
    endpoint: {
      "method": "GET",
      "group": "account",
  ...
  getNativeBalancesForAddresses: async (options = {}) => Web3Api.fetch({
    endpoint: {
      "method": "GET",
      "group": "account",
  ...
  getWalletNFTCollections: async (options = {}) => Web3Api.fetch({
    endpoint: {
      "method": "GET",
      "group": "account",
...
_defineProperty(Web3Api, "token", {
  ...
  getMultipleTokenPrices: async (options = {}) => Web3Api.fetch({
    endpoint: {
      "method": "POST",
      "group": "token",
  ...
  getErc20Transfers: async (options = {}) => Web3Api.fetch({
    endpoint: {
      "method": "GET",
      "group": "token",
  ...
  getErc20Mints: async (options = {}) => Web3Api.fetch({
    endpoint: {
      "method": "GET",
      "group": "token",
      "name": "getErc20Mints",
  ...
  getErc20Burns: async (options = {}) => Web3Api.fetch({
    endpoint: {
      "method": "GET",
      "group": "token",
      "name": "getErc20Burns",
  ...
  getErc20Approvals: async (options = {}) => Web3Api.fetch({
    endpoint: {
      "method": "GET",
      "group": "token",
  ...
  getMultipleNFTs: async (options = {}) => Web3Api.fetch({
    endpoint: {
      "method": "POST",
      "group": "token",
...
_defineProperty(Web3Api, "resolve", {
  ...
  resolveENSDomain: async (options = {}) => Web3Api.fetch({
    endpoint: {
      "method": "GET",
      "group": "resolve",
...
_defineProperty(Web3Api, "market_data", {
  getTopERC20TokensByMarketCap: async (options = {}) => Web3Api.fetch({
    endpoint: {
      "method": "GET",
      "group": "market data",
  ...
  getTopERC20TokensByPriceMovers: async (options = {}) => Web3Api.fetch({
    endpoint: {
      "method": "GET",
      "group": "market data",
  ...
  getTopNFTCollectionsByMarketCap: async (options = {}) => Web3Api.fetch({
    endpoint: {
      "method": "GET",
      "group": "market data",
  ...
  getHottestNFTCollectionsByTradingVolume: async (options = {}) => Web3Api.fetch({
    endpoint: {
      "method": "GET",
      "group": "market data",
...
_defineProperty(Web3Api, "utils", {
  reviewContracts: async (options = {}) => Web3Api.fetch({
    endpoint: {
      "method": "POST",
      "group": "utils",
