        ...
        return _regenerator.default.wrap(function (_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _ref = _args.length > 0 && _args[0] !== undefined ? _args[0] : {}, projectId = _ref.projectId, providedChainId = _ref.chainId, qrModalOptions = _ref.qrModalOptions, newSession = _ref.newSession, rpcMap = _ref.rpcMap;
              ...
              case 3:
                ...
                try {
                  WalletConnectProvider = (_require = require('@walletconnect/ethereum-provider')) === null || _require === void 0 ? void 0 : _require.EthereumProvider;
    ...
    value: function () {
      try {
        if (window) {
          ...
          (0, _forEach.default)(_context3 = (0, _keys.default)(window.localStorage)).call(_context3, function (key) {
            if ((0, _startsWith.default)(key).call(key, 'wc@')) {
