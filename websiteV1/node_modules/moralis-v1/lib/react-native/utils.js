    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _regenerator.default.awrap(_RESTController.default.ajax('GET', 'https://www.unpkg.com/moralis-v1/package.json'));
        ...
        case 3:
          ...
          if (isSemanticVersionLarger(latestVersion, installedVersion)) console.warn("Moralis: You are not using the latest version of the 'moralis-v1' SDK. Please update it as soon as possible to enjoy the newest features. Most recent version: " + latestVersion);
          _context3.next = 12;
          break;
