...
export declare class ContractDeployer extends RPCConnectionHandler {
    ...
    deployReleasedContract: {
        (publisherAddress: string, contractName: string, constructorParams: any[], version?: string | undefined, options?: DeployOptions | undefined): Promise<string>;
        prepare: (publisherAddress: string, contractName: string, constructorParams: any[], version?: string | undefined, options?: DeployOptions | undefined) => Promise<DeployTransaction>;
    };
    /**
     * Deploy any published contract by its name
     * @param publisherAddress - the address of the publisher
