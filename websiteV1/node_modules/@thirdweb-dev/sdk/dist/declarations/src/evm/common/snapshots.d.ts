 ...
 * @returns
 */
export declare function getProofsForAllowListEntry(merkleTree: MerkleTree, snapshotEntry: SnapshotEntry, tokenDecimals?: number, version?: SnapshotFormatVersion): Promise<{
    position: "left" | "right";
    data: Buffer;
}[]>;
/**
