...
export declare class Erc1155<T extends DropERC1155 | TokenERC1155 | BaseERC1155 = BaseERC1155 | BaseSignatureMintERC1155> implements UpdateableNetwork, DetectableFeature {
     ...
     */
    transferBatch: {
        (to: string, tokenIds: BigNumberish[], amounts: BigNumberish[], fromAddress?: string | undefined, data?: BytesLike | undefined): Promise<Omit<{
            receipt: import("@ethersproject/abstract-provider").TransactionReceipt;
            data: () => Promise<unknown>;
        }, "data">>;
        prepare: (to: string, tokenIds: BigNumberish[], amounts: BigNumberish[], fromAddress?: string | undefined, data?: BytesLike | undefined) => Promise<Transaction<Omit<{
            receipt: import("@ethersproject/abstract-provider").TransactionReceipt;
            data: () => Promise<unknown>;
        }, "data">>>;
    };
