import { b2 as getChainProvider, aM as fetchPublishedContractFromPolygon, aL as THIRDWEB_DEPLOYER$1, aN as fetchAndCacheDeployMetadata, aB as getCreate2FactoryAddress, aJ as encodeConstructorParamsForImplementation, aI as computeDeploymentInfo, az as isContractDeployed, aa as resolveImplementation, K as fetchContractMetadataFromAddress, as as fetchSourceFilesFromMetadata, a5 as extractConstructorParamsFromAbi, a8 as resolveContractUriFromAddress, aU as getContractPublisherAddress, ae as fetchExtendedReleaseMetadata, ct as RPCConnectionHandler, aP as resolveAddress, Y as getDefaultGasOverrides, aQ as signTypedDataInternal, aW as ChainId, cu as ContractWrapper, aZ as NATIVE_TOKEN_ADDRESS, cv as extractFeatures, af as detectFeatures, aV as getMultichainRegistryAddress, bn as AbiSchema, av as COMMON_FACTORY, aA as isEIP155Enforced, cw as CUSTOM_GAS_FOR_CHAIN, aK as getCreate2FactoryDeploymentInfo, aS as CONTRACT_ADDRESSES, cx as AddressZero, P as PackInitializer, b as MarketplaceV3Initializer, M as MarketplaceInitializer, f as SplitInitializer, V as VoteInitializer, g as TokenInitializer, T as TokenDropInitializer, a as EditionInitializer, E as EditionDropInitializer, c as MultiwrapInitializer, e as SignatureDropInitializer, N as NFTCollectionInitializer, d as NFTDropInitializer, aG as computeForwarderAddress, h as PREBUILT_CONTRACTS_MAP, k as getContractName, bJ as CommonPlatformFeeSchema, bI as CommonPrimarySaleSchema, bK as CommonTrustedForwarderSchema, bF as CommonContractSchema, bH as CommonRoyaltySchema, bL as CommonSymbolSchema, aE as computeDeploymentAddress, aD as getInitBytecodeWithSalt, aX as setSupportedChains, j as getContractTypeForRemoteName, b7 as getSignerAndProvider, ao as getCompositeABI, b5 as isChainConfig, aT as getContractAddressByChainId, cy as getProcessEnv, bV as DropErc721ContractSchema, i as PREBUILT_CONTRACTS_APPURI_MAP, b1 as EventType } from './index-4902f18c.esm.js';
import { isBrowser, ThirdwebStorage } from '@thirdweb-dev/storage';
import { C as ContractPublisher } from './contract-publisher-186e0b1e.esm.js';
...
import { b as buildTransactionFunction, T as Transaction, a as buildDeployTransactionFunction, D as DeployTransaction } from './transactions-bf210f84.esm.js';
import { i as isNativeToken, a as fetchCurrencyValue, C as ContractEncoder } from './fetchCurrencyValue-f402c164.esm.js';
...
import { g as getDeploymentInfo, c as createTransactionBatches, a as deployWithThrowawayDeployer, d as deployContractDeterministic } from './deployContractDeterministic-2a89e88f.esm.js';
...
class ThirdwebSDK extends RPCConnectionHandler {
  ...
  async getContractFromAbi(address, abi) {
    const [resolvedAddress, {
      SmartContract
    }] = await Promise.all([resolveAddress(address), import('./smart-contract-dcf205a6.esm.js')]);
    if (this.contractCache.has(resolvedAddress)) {
      return this.contractCache.get(resolvedAddress);
    }
