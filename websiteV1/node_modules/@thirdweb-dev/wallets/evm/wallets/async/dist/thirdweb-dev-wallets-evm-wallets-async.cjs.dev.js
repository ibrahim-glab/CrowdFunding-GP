...
class AsyncWallet extends evm_wallets_abstract_dist_thirdwebDevWalletsEvmWalletsAbstract.AbstractWallet {
  ...
  async getSigner() {
    if (!classPrivateFieldSet._classPrivateFieldGet(this, _signer) || !classPrivateFieldSet._classPrivateFieldGet(this, _options).cacheSigner) {
      classPrivateFieldSet._classPrivateFieldSet(this, _signer, await classPrivateFieldSet._classPrivateFieldGet(this, _options).getSigner());
    }
