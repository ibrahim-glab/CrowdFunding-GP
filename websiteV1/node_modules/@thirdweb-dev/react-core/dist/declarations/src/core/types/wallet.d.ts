...
export type ConnectionStatus = "unknown" | "connected" | "disconnected" | "connecting";
...
export type WalletConnectParams<I extends WalletInstance> = Parameters<I["connect"]>[0];
type ConnectArgs<I extends WalletInstance> = undefined extends WalletConnectParams<I> ? [connectParams?: NonNullable<WalletConnectParams<I>>] : [connectParams: NonNullable<WalletConnectParams<I>>];
/**
 * @wallet
 */
