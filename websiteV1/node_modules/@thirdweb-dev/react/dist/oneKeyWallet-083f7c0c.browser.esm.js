...
import React, { useContext, useState, useEffect, useRef, useCallback, useDeferredValue, useMemo, memo, Suspense, lazy } from 'react';
...
function useRainbowWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await import('./safeChainSlug-27254a82.browser.esm.js').then(function (n) { return n.R; });
...
function useTrustWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      trustWallet
    } = await import('./safeChainSlug-27254a82.browser.esm.js').then(function (n) { return n.u; });
...
function useMetamask() {
  ...
  return useCallback(async options => {
    const {
      metamaskWallet
    } = await import('./safeChainSlug-27254a82.browser.esm.js').then(function (n) { return n.n; });
...
function useCoinbaseWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await import('./safeChainSlug-27254a82.browser.esm.js').then(function (n) { return n.l; });
...
function useFrameWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      frameWallet
    } = await import('./frameWallet-eddfe811.browser.esm.js');
...
function usePaperWallet() {
  ...
  return useCallback(async options => {
    const {
      paperWallet
    } = await import('./paperWallet-6bb05b7e.browser.esm.js');
...
function useWalletConnectV1() {
  ...
  return useCallback(async options => {
    const {
      walletConnectV1
    } = await import('./walletConnectV1-ec1c5354.browser.esm.js');
...
function useWalletConnect() {
  ...
  return useCallback(async options => {
    const {
      walletConnect
    } = await import('./safeChainSlug-27254a82.browser.esm.js').then(function (n) { return n.q; });
