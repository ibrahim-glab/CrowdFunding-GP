...
class MerkleTree extends Base$1 {
  ...
  createHashes(nodes) {
    ...
    while (nodes.length > 1) {
      ...
      for (let i = 0; i < nodes.length; i += 2) {
        ...
        let combined = null;
        if (this.isBitcoinTree) {
          combined = [reverse__default["default"](left), reverse__default["default"](right)];
        } else {
          combined = [left, right];
        }
        if (this.sortPairs) {
  ...
  verify(proof, targetNode, root) {
    ...
    for (let i = 0; i < proof.length; i++) {
      ...
      const buffers = [];
      if (this.isBitcoinTree) {
        buffers.push(reverse__default["default"](hash));
        buffers[isLeftNode ? "unshift" : "push"](reverse__default["default"](data));
  ...
  toTreeString() {
    ...
    return treeify.asTree(obj, true, false);
  }
